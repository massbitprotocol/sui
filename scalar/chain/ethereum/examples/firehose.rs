use anyhow::Error;
use core::env::env_var;
use core::log::logger;
use core::prelude::{prost, tokio, tonic, MetricsRegistry};
use core::{endpoint::EndpointMetrics, firehose::FirehoseEndpoint};
...
// use hex::ToHex;
// use prost::Message;
// use scalar_chain_ethereum::common::firehose::endpoint::FirehoseEndpoint;
