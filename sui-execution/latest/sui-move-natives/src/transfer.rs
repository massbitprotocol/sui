...
use crate::{
    dynamic_field::get_tag_and_layout, get_receiver_object_id,
...
pub fn receive_object_internal(
    ...
    // This is checked in transaction manager as well, but we double-check here to be safe.
    ...
    let global_value_result = object_runtime.receive_object(
        parent,
        child_id,
    ...
    let mut global_value = match global_value_result {
